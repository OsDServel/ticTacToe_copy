#tic tac toe game using python @codehub
...
b4.grid(row= 2, column= 0, sticky= "nwse", ipadx= 50, ipady= 50)
...
b7.grid(row= 3, column= 0, sticky= "nwse", ipadx= 50, ipady= 50)
...
Button(text= "New Game..", font=( "Papyrus", 22, 'bold'), bg= 'Purple', fg= 'white', border= 5, width= 4,
	command= lambda :Restart()).grid(row= 0, column= 1, sticky= "we")
root.resizable(0, 0)
root.mainloop()